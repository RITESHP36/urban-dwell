...
const OurValues = () => {
	return (
		<div>
          ...
          src="https://real-estate-web.pages.dev/hero-image.png" alt="" />
				</div>
				{/* right */}
				<div className="px-8 mt-5">
					<div className="">
						<h2 className="text-2xl sm:text-3xl font-bold text-yellow-500">Our Value</h2>
						<h2 className="text-2xl font-bold text-blue-800">Value We Give To You</h2>
